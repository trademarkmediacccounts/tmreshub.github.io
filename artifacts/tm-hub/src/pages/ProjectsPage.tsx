...
export default function ProjectsPage() {
  ...
  const [form, setForm] = useState({ name: "", description: "", type: "Commercial", client: "", startDate: "", endDate: "" });
  ...
  const handleCreate = () => {
    ...
    createProject.mutate(payload as any, {
      onSuccess: () => {
        setDialogOpen(false);
        setForm({ name: "", description: "", type: "Commercial", client: "", startDate: "", endDate: "" });
      },
    });
  };
