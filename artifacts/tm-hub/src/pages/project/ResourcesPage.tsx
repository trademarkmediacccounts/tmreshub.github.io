...
const empty = { name: "", category: "Equipment", quantity: 1, status: "Needed", assignedTo: "", supplier: "", cost: 0, notes: "" };
...
export default function ResourcesPage() {
  ...
  const openEdit = (r: ProjectResource) => {
    ...
    setForm({
      ...
      assignedTo: r.assignedTo || "", supplier: r.supplier || "", cost: Number(r.cost) || 0, notes: r.notes || "",
    });
    setDialogOpen(true);
  };
              ...
              <tbody>
                {filtered.map((r, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 text-muted-foreground">{r.assignedTo || "—"}</td>
