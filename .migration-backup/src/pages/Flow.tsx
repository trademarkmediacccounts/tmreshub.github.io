...
const emptyForm = { name: "", company: "", value: "", currency: "£", service: "", stage: "Lead", notes: "", project_id: "" };
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="flex items-center gap-1 text-muted-foreground">
                          <Calendar className="w-3 h-3" />{new Date(lead.created_at).toLocaleDateString("en-GB", { day: "numeric", month: "short" })}
                        </span>
                      </div>
